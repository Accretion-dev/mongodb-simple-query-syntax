...
let {parse: NumberParser}      = require('./pegjs/filter-number.js').default
let {parse: DateParser}        = require('./pegjs/filter-date.js').default
let {parse: MongodbDateParser} = require('./pegjs/filter-date-mongodb.js').default
